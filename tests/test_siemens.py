...
class TestConversionSiemens(unittest.TestCase):
    def test_dti(self):
        ...
        try:
            ...
            assert compare_bval(results['BVAL_FILE'],
                                ground_thruth_filenames(test_data.SIEMENS_DTI)[1]) == True
            ...
            assert compare_bval(results['BVAL_FILE'],
                                ground_thruth_filenames(test_data.SIEMENS_DTI_IMPLICIT)[1]) == True
            assert compare_bvec(results['BVEC_FILE'],
            ...
            assert compare_bval(results['BVAL_FILE'],
                                ground_thruth_filenames(test_data.SIEMENS_CLASSIC_DTI)[1]) == True
            assert compare_bvec(results['BVEC_FILE'],
            ...
            assert compare_bval(results['BVAL_FILE'],
                                ground_thruth_filenames(test_data.SIEMENS_CLASSIC_DTI_IMPLICIT)[1]) == True
            assert compare_bvec(results['BVEC_FILE'],
    ...
    def test_is_mosaic(self):
        ...
        assert not convert_siemens._is_mosaic(convert_siemens._classic_get_grouped_dicoms(test_data.SIEMENS_CLASSIC_DTI))
        assert not convert_siemens._is_mosaic(convert_siemens._classic_get_grouped_dicoms(test_data.SIEMENS_CLASSIC_FMRI))
    ...
    def test_is_classic_fmri(self):
        ...
        assert not convert_siemens._is_classic_frmi(convert_siemens._classic_get_grouped_dicoms(test_data.SIEMENS_CLASSIC_DTI))
        assert convert_siemens._is_classic_frmi(convert_siemens._classic_get_grouped_dicoms(test_data.SIEMENS_CLASSIC_FMRI))
        assert not convert_siemens._is_classic_frmi(convert_siemens._classic_get_grouped_dicoms(test_data.SIEMENS_ANATOMICAL))
    ...
    def test_is_classic_dti(self):
        ...
        assert convert_siemens._is_classic_dti(convert_siemens._classic_get_grouped_dicoms(test_data.SIEMENS_CLASSIC_DTI))
        assert not convert_siemens._is_classic_dti(convert_siemens._classic_get_grouped_dicoms(test_data.SIEMENS_CLASSIC_FMRI))
        assert not convert_siemens._is_classic_dti(convert_siemens._classic_get_grouped_dicoms(test_data.SIEMENS_ANATOMICAL))
